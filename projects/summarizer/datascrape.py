...
articles += [(url, summary, "mtv") for url, summary in zip(
    [
        ...
        "https://www.mtvuutiset.fi/artikkeli/trumpin-vihjailu-kolmannesta-kaudesta-yltyy-myynnissa-hammastyttava-tuote/9143602",
        "https://www.mtvuutiset.fi/artikkeli/suomalaisopiskelija-aku-seuraa-aitiopaikalta-trumpin-harvard-hyokkaysta-pelottava-tilanne/9143368",  # Add comma here
    ...
    [
        ...
        "Suomalaisopiskelija Aku Koskenvuo seuraa Harvardin yliopistolla pelonsekaisin tuntein, kun Trumpin hallinnon toimet uhkaavat yliopiston itsenäisyyttä. Hallinto on jäädyttänyt yli 2,2 miljardia dollaria rahoitusta vaatimalla muun muassa monimuotoisuusohjelmien lopettamista ja muutoksia opetuskäytäntöihin. Koskenvuo, joka opiskelee taloustiedettä ja pelaa jääkiekkoa NHL:ssä, kertoo kansainvälisten opiskelijoiden kokevan tilanteen pelottavana ja epävarmana. Harvard on haastanut hallinnon oikeuteen puolustaakseen akateemista vapauttaan.",
